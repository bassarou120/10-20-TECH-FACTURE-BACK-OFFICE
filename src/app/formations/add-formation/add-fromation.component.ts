...
@Component({
  ...
  templateUrl: './add-fromation.component.html',
  styleUrls: ['./add-fromation.component.styl']
})
export class AddFromationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      if(type){
        ...
        this.card_header_title = "MODIFIER LA FORMATION"
  ...
  this.actualiteService.getById(id).subscribe(response=>{
    ...
    this.actualiteForm.get('prix').setValue(response['data'].prix);
