...
@Component({
    ...
    styleUrls: ['./partenariat.component.styl']
})
export class PartenariatComponent implements OnInit {
    ...
    listPartSudSud: Array<Actualite> = [];
    listPartInterHospitaliere: Array<Actualite> = [];
    listCooperationInter: Array<Actualite> = [];
   listRelationApuiSponsor: Array<Actualite> = [];
    ...
    ngOnInit() {
        this.getListPartSudSud();
        this.getListPartInterHospitaliere();
        this.getListCooperationInter();
        this.getListRelationApuiSponsor();
    }
    ...
    getListPartSudSud(): void {
        this.actualiteService.getByType("PARTENARIAT-SUD-SUD").subscribe((data: Array<Actualite>) => {
                this.listPartSudSud = data['data'];
    ...
    getListPartInterHospitaliere(): void {
        this.actualiteService.getByType("PARTENARIAT-INTER-HOSPITALIERE").subscribe((data: Array<Actualite>) => {
                this.listPartInterHospitaliere = data['data'];
                this.spinner = false;
            }, (error: HttpErrorResponse) => {
                console.log("Error while retrieving data");
            }
    ...
    getListCooperationInter(): void {
        this.actualiteService.getByType("COOPERATION-INTERNATIONALE").subscribe((data: Array<Actualite>) => {
                this.listCooperationInter = data['data'];
                this.spinner = false;
            }, (error: HttpErrorResponse) => {
                console.log("Error while retrieving data");
            }
    ...
    getListRelationApuiSponsor(): void {
        this.actualiteService.getByType("RELATION-APPUI-SPONSORING").subscribe((data: Array<Actualite>) => {
                this.listRelationApuiSponsor = data['data'];
                this.spinner = false;
            }, (error: HttpErrorResponse) => {
                console.log("Error while retrieving data");
            }
