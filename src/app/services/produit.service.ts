...
export class ProduitService {
  ...
  save(data:any ): Observable<Object> {
    return this.http.post(`${this.url}/produits`, data);
  }
  ...
  getById(id: number): Observable<Object> {
    return this.http.get(`${this.url}/produits/${id}`);
  }

  // Modification d'un element
  edit(data:any,id: number): Observable<Object> {
    return this.http.put(`${this.url}/produits/${id}`, data );
  }

  // Supression d'un element
  delete(id: number): Observable<Object> {
    return this.http.delete(`${this.url}/produits/${id}`);
  }
